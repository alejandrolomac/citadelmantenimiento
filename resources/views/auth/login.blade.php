...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form role="form" id="loginForm" onsubmit="event.preventDefault();">
                                        @csrf
                                        <div class="flex flex-col mb-3">
                                            <div class="alert alert-danger mb-1" role="alert" id="email-error-alert"
                                                style="color: white; display: none;">
                                                <span id="email-error" style="color: white;"></span>
                                            </div>
                                            <input type="email" id="email"
                                                name="email"class="form-control form-control-lg" value=""
                                                aria-label="Email" placeholder="Correo Electrónico"
                                        ...
                                        <div class="flex flex-col mb-3">
                                            ...
                                            <div class="position-relative">
                                                <input type="password" id="password" name="password"
                                                    class="form-control form-control-lg pe-5" aria-label="Password"
                                                    placeholder="Contraseña" oninput="validatePassword(this.value)">

                                                <button
                                                    class="position-absolute top-50 end-0 translate-middle-y me-2 p-0 border-0"
                                        ...
                                        <div class="text-center">
                                            <button type="button" id="submitLoginBtn"
                                                class="btn btn-lg bg-gradient-warning text-white w-100 mt-4 mb-0">Iniciar
                                                Sesión</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-warning h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden">
                                <img src="{{ asset('img/logow.png') }}" alt="Citadel Logo" class="position-relative w-75 mx-auto mb-4" style="z-index: 1;">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.getElementById('submitLoginBtn').addEventListener('click', async function(e) {
            e.preventDefault();
            ...
            if (email === "" || password === "") {
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Advertencia',
                    text: 'Por favor, ingrese su correo electrónico y contraseña correctamente.'
                });
            ...
            try {
                const response = await fetch('/login2', {
                    ...
                    headers: {
                        ...
                        'X-CSRF-TOKEN': token // Agregar el token CSRF en los headers
                    },
                    body: JSON.stringify({
                        email,
                        password
                ...
                if (response.ok) {
                    Swal.fire({
                        ...
                        customClass: {
                            confirmButton: 'btn bg-gradient-warning text-white'
                        },
